...
#
# COMMAND-LINE ARGS:
#   -e <num-events>     number of events to run per algorithm (default: 100)
...
#   cmsenv
#   bash l1tk-test.sh -e <num-events> -j <parallel-jobs>
#   (defaults: -e 100 -j 1 if omitted)
# Can instead run 'official' local unit test by adding l1tk-test.sh to src/.../test/BuildFile.xml
